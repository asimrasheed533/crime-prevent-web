...
export default function UserLanding() {
  ...
  return (
    <div className="user__landing__container__main">
      ...
      <div className="user__landing__container__two">
          ...
          <div className="user__landing__container__two__content__main__card">
            ...
            <div className="user__landing__container__two__content__main__card__right">
              ...
              <div className="user__landing__container__two__content__main__card__right__para">
                Nowadays the crime rate is frequently increasing day by day in
                our society. Problem was that people got tired by going here and
                there for getting justice. From this we get an idea to develop
                the system.
                <div style={{ marginTop: "1em" }}>
                  Our application is capable of registering FIR online, shows
                  investigation update, deliver news about crime etc. So it is
                  an application which provides solution to the problems faced
                  during taking actions against crime.
                </div>
                <div style={{ marginTop: "1em" }}>
